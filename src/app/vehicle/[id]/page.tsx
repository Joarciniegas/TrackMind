      ...
      <div className="bg-gray-300 h-48 flex items-center justify-center relative">
        ...
        {permissions.canEdit && (
          <div className="absolute bottom-3 right-3 flex gap-2">
            {/* Galería */}
            <label className="bg-white text-blue-600 p-3 rounded-full shadow-lg cursor-pointer hover:bg-gray-100 transition border border-gray-200">
              {uploading ? (
            ...
            {/* Cámara */}
            <label className="bg-blue-600 text-white p-3 rounded-full shadow-lg cursor-pointer hover:bg-blue-700 transition">
              {uploading ? (
                <svg className="w-6 h-6 animate-spin" fill="none" viewBox="0 0 24 24">
                  <circle className="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" strokeWidth="4"></circle>
                  <path className="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z"></path>
